...
const translations = {
  de: {
    ...
    // Article Content
    'article.title': 'AniWorld App: Kostenlose APK für Android herunterladen & Animes schauen',
  ...
  en: {
    ...
    // Article Content
    'article.title': 'AniWorld App: Download Free APK for Android & Watch Animes',
